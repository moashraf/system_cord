...
$subject =" corddigital   landingpage ";
...
$mail->Username = "info@magic-windows.com";  // SMTP username
$mail->Password = "!Brg^uB}asvC"; // SMTP password

$mail->From = "info@corddigital.com";
$mail->FromName = "corddigital.com";
$mail->CharSet = 'UTF-8';
    	          $namerand = '-'.rand(1,900).'-';

 $mail->AddAddress(" info@cord.digital  ", " $namerand  corddigital.com");
  $mail->AddAddress("info@corddigital.com", " $namerand  corddigital.com");
  $mail->AddAddress("Sales@corddigital.com", "  $namerand  corddigital.com");
  
 $mail->AddReplyTo("info@corddigital.com", "   $namerand corddigital.com ");
$mail->WordWrap = 50;                                 // set word wrap to 50 characters
$mail->IsHTML(true);                                  // set email format to HTML

$mail->Subject = "   $namerand corddigital.com ";
...
if(!$mail->Send()|| isset($_POST['phone']) )
{
          header("Location:https://corddigital.com/public/landingpage/thanks.html");
   ...
   header("Location:http://corddigital.com");
