            ...
            <div id="compact_submenuSidebar" class="submenu-sidebar">
                ...
                <div class="submenu" id="pages">
                    <ul class="submenu-list" data-parent-element="#pages">
                        ...
                        <li>
                            <a href="pages_error404.html"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        class="feather feather-git-commit">
                                        <circle cx="12" cy="12" r="4"></circle>
                        ...
                        <li>
                            <a href="pages_error500.html"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        class="feather feather-git-commit">
                                        <circle cx="12" cy="12" r="4"></circle>
                        ...
                        <li>
                            <a href="pages_error503.html"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        class="feather feather-git-commit">
                                        <circle cx="12" cy="12" r="4"></circle>
                        ...
                        <li>
                            <a href="pages_maintenence.html"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        class="feather feather-git-commit">
                                        <circle cx="12" cy="12" r="4"></circle>
                ...
                <div class="content-container">
                    ...
                    <div class="container">
                        <div class="d-flex justify-content-around mt-5">
                            ...
                            <h3 class="font-weight-bold">All Sales 320</h3>
                            <form action="#">
                                <input type="text" placeholder="Search Sellers" class="border-0 rounded px-3 py-2"
                                    name="" id="">
                            </form>
                        </div>
                        <div class="row mt-3">
                            <div class="col-lg-6">
                                <div class="card rounded shadow">
                                    <div class="card-header bg-transparent border-0 text-center">
                                        <h6 class="font-weight-bold text-uppercase w-info">Kareem Mohsen</h6>
                                        ...
                                        <div class="">
                                            <div class="widget-content">
                                                ...
                                                <div class="w-progress-stats w-50 m-auto text-center">
                                                    <h6 class="font-weight-bold text-primary">150</h6>
                                            ...
                                            <div class="d-flex justify-content-around mt-5">
                                               <div class="text-center">
                                                <div role="progressbarRounded" aria-valuenow="65" aria-valuemin="0"
                                                aria-valuemax="100" style="--value:65" class="m-auto bg-success-radiual text-success font-weight-bold"></div>
                                                <p class="text-success font-weight-bold">done</p>
                                               </div>
                                               <div class="text-center">
                                                <div role="progressbarRounded" aria-valuenow="65" aria-valuemin="0"
                                                aria-valuemax="100" style="--value:65"  class="m-auto bg-danger-radiual text-danger font-weight-bold"></div>
                                                <p class="text-danger font-weight-bold">Not Achived</p>
                                               </div>
                                               <div class="text-center">
                                                <div role="progressbarRounded" aria-valuenow="65" aria-valuemin="0"
                                                aria-valuemax="100" style="--value:65" class="m-auto bg-primary-radiual text-primary font-weight-bold"></div>
                                                <p class="text-primary font-weight-bold">in progress</p>

                                            </div>
                                            <div class="text-center">
                                                <div role="progressbarRounded" aria-valuenow="65" aria-valuemin="0"
                                                aria-valuemax="100" style="--value:65" class="m-auto bg-gray-radiual text-gray font-weight-bold"></div>
                                                <p class="text-gray font-weight-bold">so close</p>

                                            </div>
                                            <div class="text-center">
                                                <div role="progressbarRounded" aria-valuenow="65" aria-valuemin="0"
                                                aria-valuemax="100" style="--value:65"  class="m-auto bg-primary-radiual text-primary font-weight-bold"></div>
                                                <p class="text-primary font-weight-bold">other</p>
                        ...
                        <section style="height: 50vh;">
                            <div class="card mt-5 shadow rounded h-75">
                                <div class="card-header bg-transparent border-0">
                                    <h6 class="font-weight-bold">Sources</h6>
                                </div>
                                <div class="card-body pb-0 d-flex justify-content-around align-items-end"
                                    style="background-image: url('assets/img/lines.png'); background-position: center; background-size: contain;">
                                    <div
                                        class="h-100 d-flex align-items-end justify-content-end flex-column text-center">
                                        <p class="text-primary font-weight-bold">50%</p>
                                        <div class="card bg-primary" style="width: 20px; height: 60%;"></div>
                                    </div>
                                    <div
                                        class="h-100 d-flex align-items-end justify-content-end flex-column text-center">
                                        <p class="text-primary font-weight-bold">50%</p>
                                    ...
                                    <div
                                        class="h-100 d-flex align-items-end justify-content-end flex-column text-center">
                                        <p class="text-primary font-weight-bold">50%</p>
                                        <div class="card bg-primary" style="width: 20px; height: 5%;"></div>
                                    </div>
                                    <div
                                        class="h-100 d-flex align-items-end justify-content-end flex-column text-center">
                                        <p class="text-primary font-weight-bold">50%</p>
                                ...
                                <div class="card-footer bg-transparent d-flex justify-content-around">
                                    ...
                                    <h6 class="font-weight-bold text-uppercase text-center">Facebook <br> (36) </h6>
                                    <h6 class="font-weight-bold text-uppercase text-center">Facebook <br> (36) </h6>
                                    <h6 class="font-weight-bold text-uppercase text-center">Facebook <br> (36) </h6>
                                    <h6 class="font-weight-bold text-uppercase text-center">Facebook <br> (36) </h6>
                                    <h6 class="font-weight-bold text-uppercase text-center">Facebook <br> (36) </h6>
                                    ...
                                    <h6 class="font-weight-bold text-uppercase text-center">Facebook <br> (36) </h6>
                                    <h6 class="font-weight-bold text-uppercase text-center">Facebook <br> (36) </h6>
                                    <h6 class="font-weight-bold text-uppercase text-center">Facebook <br> (0) </h6>
                                    <h6 class="font-weight-bold text-uppercase text-center">Facebook <br> (0) </h6>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="card shadow">
                                             <div class="card-body">
                                                <div class="row">
                                                    <div class="col-lg-5 text-center" style="border-right: 0.1px solid gray;">
                                                        <h6 class="text-uppercase font-weight-bold">Digital Marketing</h6>
                                                        <p class="text-primary font-weight-bold">150</p>
                                                        <img src="assets/img/digital-mark.png" class="img-fluid" alt="">
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <div class="row">
